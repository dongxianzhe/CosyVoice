...
from cosyvoice.cli.model import CosyVoice3
import torchaudio
...
def cosyvoice3_example():
    ...
    for i, j in enumerate(cosyvoice.inference_zero_shot(tts_text, prompt_text='You are a helpful assistant.<|endofprompt|>希望你以后能够做的比我还好呦。', prompt_wav=prompt_wav, stream=False)):
